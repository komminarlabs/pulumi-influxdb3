...
func computeDatabaseID() tfbridge.ComputeID {
	return tfbridge.DelegateIDField(resource.PropertyKey("name"),
		"influxdb3", "https://github.com/pulumi/pulumi-influxdb3")
}
...
func Provider() tfbridge.ProviderInfo {
	info := tfbridge.ProviderInfo{
		...
		P:                 pfbridge.ShimProvider(influxdb3shim.NewProvider(version.Version)),
		Name:              "influxdb3",
	...
	info.MustComputeTokens(tokens.SingleModule("influxdb3_", mainMod,
