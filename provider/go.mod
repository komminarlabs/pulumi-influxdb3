module github.com/komminarlabs/pulumi-influxdb3/provider
...
replace (
	...
	github.com/komminarlabs/terraform-provider-influxdb3/shim => ./shim
)

require (
	github.com/komminarlabs/terraform-provider-influxdb3/shim v0.0.0
...
require (
	...
	github.com/komminarlabs/influxdb3 v0.1.2 // indirect
	github.com/komminarlabs/terraform-provider-influxdb3 v1.3.0 // indirect
