...
namespace KomminarLabs.InfluxDB3
{
    public static class GetDatabases
    {
        ...
        public static Task<GetDatabasesResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDatabasesResult>("influxdb3:index/getDatabases:getDatabases", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Gets all databases for a cluster.
        /// </summary>
        public static Output<GetDatabasesResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDatabasesResult>("influxdb3:index/getDatabases:getDatabases", InvokeArgs.Empty, options.WithDefaults());
    }
