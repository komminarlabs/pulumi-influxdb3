...
namespace KomminarLabs.InfluxDB3
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("KomminarLabs.InfluxDB3.version.txt");
    ...
    internal sealed class InfluxDB3ResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public InfluxDB3ResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
